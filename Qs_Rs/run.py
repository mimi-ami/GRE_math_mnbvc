...
def save(question, answer):
    ...
    file_path = f"D:/github_project/GRE_math_crewler/Qs_Rs/question.json"
...
if __name__ == "__main__":
    ...
    # 问题
    question_url = "https://www.test-guide.com/courses/gre/lessons/gre-quantitative-reasoning-practice-sets/quizzes/gre-math-multiple-choice-many-practice-test-1" # 问题
